from PyQt5.QtWidgets import QDialog, QVBoxLayout, QLabel, QComboBox, QSlider, QHBoxLayout, QWidget, QCheckBox, QSpinBox, QPushButton, QFormLayout, QGridLayout,QSizePolicy
